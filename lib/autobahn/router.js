  ...
  function drawRoutes () {
    ...
    function mapRoutes (chain) {
      return {
        ...
        del: function() {
          return mapRoutes(generateRoute("del", chain, arguments))
        }
      }
    }
    ...
    return {
      ...
      del: function() {
        return mapRoutes(generateRoute("del", [], arguments))
      }
    }
  }
    ...
    route: function(req, res) {
      ...
      if (hit) {
        if (_.include(_.keys(Routes[hit].actions)), req.method.toLowerCase()) {
          ...
          autobahn.not_permitted(req, res)
        }
      } else {
        autobahn.not_found(req, res)
      }
    }
  }
}
